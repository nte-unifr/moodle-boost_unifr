...
define(['jquery'], function($) {
    ...
    function initInCourseSettings() {
        ...
        if (!frontpage) {
            ...
            var courseSettings = $('#boost-unifr-course-settings');
            var activitySettings = $('#boost-unifr-activity-settings');
            ...
            courseSettingsDropdownToggle.removeAttr('aria-haspopup').attr('aria-controls', 'boost-unifr-course-settings');
            ...
            activitySettingsDropdownToggle.removeAttr('aria-haspopup').attr('aria-controls', 'boost-unifr-activity-settings');
