...
$THEME->name = 'boost_unifr';
$THEME->parents = ['boost'];
$THEME->editor_sheets = [];
$THEME->scss = function($theme) {
    return theme_boost_unifr_get_main_scss_content($theme);
};
...
if (get_config('theme_boost_unifr', 'footerblocks') == '1columns') {
    $regions[] = 'footer-left';
...
$THEME->prescsscallback = 'theme_boost_unifr_get_pre_scss';
$THEME->yuicssmodules = array();
$THEME->rendererfactory = 'theme_overridden_renderer_factory';
$THEME->requiredblocks = ' ';
if (get_config('theme_boost_unifr', 'addablockposition') == 'positionnavdrawer') {
