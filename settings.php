...
if ($ADMIN->fulltree) {
    ...
    $settings = new theme_boost_admin_settingspage_tabs('themesettingboost_unifr',
        get_string('configtitle', 'theme_boost_unifr', null, true));


    // Create general tab.
    $page = new admin_settingpage('theme_boost_unifr_general', get_string('generalsettings', 'theme_boost', null, true));

    // Settings title to group preset related settings together with a common heading. We don't want a description here.
    $name = 'theme_boost_unifr/presetheading';
    $title = get_string('presetheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Replicate the preset setting from theme_boost.
    $name = 'theme_boost_unifr/preset';
    ...
    $fs = get_file_storage();
    $files = $fs->get_area_files($context->id, 'theme_boost_unifr', 'preset', 0, 'itemid, filepath, filename', false);
    ...
    $name = 'theme_boost_unifr/presetfiles';
    ...
    $name = 'theme_boost_unifr/backgroundimageheading';
    $title = get_string('backgroundimage', 'theme_boost', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Background image setting.
    $name = 'theme_boost_unifr/backgroundimage';
    $title = get_string('backgroundimage', 'theme_boost', null, true);
    $description = get_string('backgroundimage_desc', 'theme_boost', null, true);
    $description .= get_string('backgroundimage_desc_note', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/brandcolorheading';
    $title = get_string('brandcolorheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);
    ...
    $name = 'theme_boost_unifr/faviconheading';
    $title = get_string('faviconheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Favicon upload.
    $name = 'theme_boost_unifr/favicon';
    $title = get_string('faviconsetting', 'theme_boost_unifr', null, true);
    $description = get_string('faviconsetting_desc', 'theme_boost_unifr', null, true);
    ...
    $page = new admin_settingpage('theme_boost_unifr_advanced', get_string('advancedsettings', 'theme_boost', null, true));
    ...
    $name = 'theme_boost_unifr/catchkeyboardcommandsheading';
    $title = get_string('catchkeyboardcommandsheadingsetting', 'theme_boost_unifr', null, true);
    $description = get_string('catchkeyboardcommandsheadingsetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, $description);
    $page->add($setting);

    // Setting for catching the end key.
    $name = 'theme_boost_unifr/catchendkey';
    $title = get_string('catchendkeysetting', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/catchcmdarrowdown';
    $title = get_string('catchcmdarrowdownsetting', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/catchctrlarrowdown';
    $title = get_string('catchctrlarrowdownsetting', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/addablockwidgetheading';
    $title = get_string('addablockwidgetheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);
    // Setting to manage where the Add a block widget should be displayed.
    $name = 'theme_boost_unifr/addablockposition';
    $title = get_string('addablockpositionsetting', 'theme_boost_unifr', null, true);
    $description = get_string('addablockpositionsetting_desc', 'theme_boost_unifr', null, true);
    $addablockpositionsetting = [
        ...
        'positionblockregion' => get_string('settingsaddablockpositionbottomblockregion', 'theme_boost_unifr', null, false),
        'positionnavdrawer' => get_string('settingsaddablockpositionbottomnavdrawer', 'theme_boost_unifr', null, true),
    ];
    ...
    $name = 'theme_boost_unifr_courselayout';
    $title = get_string('courselayoutsettings', 'theme_boost_unifr', null, true);
    $page = new admin_settingpage($name, $title);

    // Setting for displaying section-0 title in courses.
    $name = 'theme_boost_unifr/section0title';
    $title = get_string('section0titlesetting', 'theme_boost_unifr', null, true);
    $description = get_string('section0titlesetting_desc', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/coursehintsheading';
    $title = get_string('coursehintsheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Setting to display information of a switched role in the course header.
    $name = 'theme_boost_unifr/showswitchedroleincourse';
    $title = get_string('showswitchedroleincoursesetting', 'theme_boost_unifr', null, true);
    $description = get_string('showswitchedroleincoursesetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no'); // Overriding default values
    ...
    $name = 'theme_boost_unifr/showhintcoursehidden';
    $title = get_string('showhintcoursehiddensetting', 'theme_boost_unifr', null, true);
    $description = get_string('showhintcoursehiddensetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no'); // Overriding default values
    // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php).
    // Default 0 value would not write the variable to scss that could cause the scss to crash if used in that file.
    // See MDL-58376.
    ...
    $name = 'theme_boost_unifr/showhintcourseguestaccess';
    $title = get_string('showhintcoursguestaccesssetting', 'theme_boost_unifr', null, true);
    $description = get_string('showhintcourseguestaccesssetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no'); // Overriding default values
    // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php).
    // Default 0 value would not write the variable to scss that could cause the scss to crash if used in that file.
    // See MDL-58376.
    ...
    // Settings title for grouping course settings related aspects together. We don't need a description here.
    $name = 'theme_boost_unifr/coursesettingsheading';
    $title = get_string('coursesettingsheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Setting to display the course settings page as a panel within the course.
    $name = 'theme_boost_unifr/showsettingsincourse';
    $title = get_string('showsettingsincoursesetting', 'theme_boost_unifr', null, true);
    $description = get_string('showsettingsincoursesetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no'); // Overriding default values
    // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php).
    // Default 0 value would not write the variable to scss that could cause the scss to crash if used in that file.
    // See MDL-58376.
    ...
    $name = 'theme_boost_unifr/incoursesettingsswitchtoroleposition';
    $title = get_string('incoursesettingsswitchtorolepositionsetting', 'theme_boost_unifr', null, true);
    $description = get_string('incoursesettingsswitchtorolepositionsetting_desc', 'theme_boost_unifr', null, true);
    ...
    'no' => get_string('incoursesettingsswitchtorolesettingjustmenu', 'theme_boost_unifr', null, false),
    'yes' => get_string('incoursesettingsswitchtorolesettingjustcourse', 'theme_boost_unifr', null, true),
    'both' => get_string('incoursesettingsswitchtorolesettingboth', 'theme_boost_unifr', null, true)
    ];
    $setting = new admin_setting_configselect($name, $title, $description, $incoursesettingsswitchtorolesetting['no'],
        $incoursesettingsswitchtorolesetting);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    $settings->hide_if('theme_boost_unifr/incoursesettingsswitchtoroleposition',
            'theme_boost_unifr/showsettingsincourse', 'notchecked');
    ...
    $name = 'theme_boost_unifr_footerlayout';
    $title = get_string('footerlayoutsettings', 'theme_boost_unifr', null, true);
    $page = new admin_settingpage($name, $title);

    // Settings title for the footer blocks. We don't need a description here.
    $name = 'theme_boost_unifr/footerblocksheading';
    $title = get_string('footerblocksheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Setting for enabling blocks with different layouts in the footer.
    $name = 'theme_boost_unifr/footerblocks';
    $title = get_string('footerblockssetting', 'theme_boost_unifr', null, true);
    $description = get_string('footerblockssetting_desc', 'theme_boost_unifr', null, true);
    $footerlayoutoptions = [
     // Don't use string lazy loading (= false) because the string will be directly used and would produce a PHP warning otherwise.
    '0columns' => get_string('footerblocks0columnssetting', 'theme_boost_unifr', null, false),
    '1columns' => get_string('footerblocks1columnssetting', 'theme_boost_unifr', null, true),
    '2columns' => get_string('footerblocks2columnssetting', 'theme_boost_unifr', null, true),
    '3columns' => get_string('footerblocks3columnssetting', 'theme_boost_unifr', null, true)
    ];
    ...
    $name = 'theme_boost_unifr/footerlinksheading';
    $title = get_string('footerlinksheadingsetting', 'theme_boost_unifr', null, true);
    $description = get_string('footerlinksheadingsetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, $description);
    $page->add($setting);

    // Helplink.
    $name = 'theme_boost_unifr/footerhidehelplink';
    $title = get_string('footerhidehelplinksetting', 'theme_boost_unifr', null, true);
    $description = get_string('footerlinks_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no' ); // Overriding default values
        // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
        // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    // Logininfo.
    $name = 'theme_boost_unifr/footerhidelogininfo';
    $title = get_string('footerhidelogininfosetting', 'theme_boost_unifr', null, true);
    $description = get_string('footerlinks_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no' ); // Overriding default values
        // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
        // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
    ...
    // Homelink.
    $name = 'theme_boost_unifr/footerhidehomelink';
    $title = get_string('footerhidehomelinksetting', 'theme_boost_unifr', null, true);
    $description = get_string('footerlinks_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no' ); // Overriding default values
        // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
        // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
    ...
    // User tours.
    $name = 'theme_boost_unifr/footerhideusertourslink';
    $title = get_string('footerhideusertourslinksetting', 'theme_boost_unifr', null, true);
    $description = get_string('footerlinks_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no' ); // Overriding default values
    // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
    // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
    ...
    $name = 'theme_boost_unifr/hidefooterheading';
    $title = get_string('hidefooterheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Hide the footer on the login page.
    $name = 'theme_boost_unifr/hidefooteronloginpage';
    $title = get_string('hidefooteronloginpagesetting', 'theme_boost_unifr', null, true);
    $description = get_string('hidefooteronloginpagesetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no' ); // Overriding default values
    // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
    // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $name = 'theme_boost_unifr_additionallayout';
    $title = get_string('additionallayoutsettings', 'theme_boost_unifr', null, true);
    $page = new admin_settingpage($name, $title);

    // Settings title to group image area settings together with a common heading and description.
    $name = 'theme_boost_unifr/imageareaheading';
    $title = get_string('imageareaheadingsetting', 'theme_boost_unifr', null, true);
    $description = get_string('imageareaheadingsetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, $description);
    $page->add($setting);

    // Image area setting.
    $name = 'theme_boost_unifr/imageareaitems';
    $title = get_string('imageareaitemssetting', 'theme_boost_unifr', null, true);
    $description = get_string('imageareaitemssetting_desc', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/imageareaitemsmaxheight';
    $title = get_string('imageareaitemsmaxheightsetting', 'theme_boost_unifr', null, true);
    $description = get_string('imageareaitemsmaxheightsetting_desc', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/footnoteheading';
    $title = get_string('footnoteheadingsetting', 'theme_boost_unifr', null, true);
    $description = get_string('footnoteheadingsetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, $description);
    $page->add($setting);

    // Footnote setting.
    $name = 'theme_boost_unifr/footnote';
    ...
    $setting = new admin_setting_heading('theme_boost_unifr/navdrawerheading',
        get_string('navdrawerheadingsetting', 'theme_boost_unifr', null, true), null);
    $page->add($setting);
    ...
    if (get_config('core', 'defaulthomepage') == HOMEPAGE_SITE) {
        $page->add(new admin_setting_configcheckbox('theme_boost_unifr/defaulthomepageontop',
            get_string('sitehomeontopsetting', 'theme_boost_unifr', null, true),
            get_string('sitehomeontopsetting_desc', 'theme_boost_unifr', null, true), 'no', 'yes', 'no'));
            // Overriding default values yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss()
        ...
        $page->add(new admin_setting_configcheckbox('theme_boost_unifr/defaulthomepageontop',
            get_string('dashboardontopsetting', 'theme_boost_unifr', null, true),
            get_string('dashboardontopsetting_desc', 'theme_boost_unifr', null, true), 'no', 'yes', 'no'));
            // Overriding default values yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss()
            // (lib.php). Default 0 value would not write the variable to scss that could cause the scss to crash if used in
            // that file. See MDL-58376.
    } else if (get_config('core', 'defaulthomepage') == HOMEPAGE_USER) {
        $page->add(new admin_setting_configcheckbox('theme_boost_unifr/defaulthomepageontop',
            get_string('userdefinedontopsetting', 'theme_boost_unifr', null, true),
            get_string('userdefinedontopsetting_desc', 'theme_boost_unifr', null, true), 'no', 'yes', 'no'));
            // Overriding default values yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss()
            // (lib.php). Default 0 value would not write the variable to scss that could cause the scss to crash if used in
            // that file. See MDL-58376.
    } else { // This should not happen.
        $page->add(new admin_setting_configcheckbox('theme_boost_unifr/defaulthomepageontop',
            get_string('defaulthomepageontopsetting', 'theme_boost_unifr', null, true),
            get_string('defaulthomepageontopsetting_desc', 'theme_boost_unifr', null, true), 'no', 'yes', 'no'));
            // Overriding default values yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss()
            // (lib.php). Default 0 value would not write the variable to scss that could cause the scss to crash if used in
            // that file. See MDL-58376.
    }
    ...
    $name = 'theme_boost_unifr/navdrawerfullwidth';
    $title = get_string('navdrawerfullwidthsetting', 'theme_boost_unifr', null, true);
    $description = get_string('navdrawerfullwidthsettings_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no' ); // Overriding default
    // values yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value
    ...
    $title = get_string('loginpagedesignheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Login page background setting.
    $name = 'theme_boost_unifr/loginbackgroundimage';
    $title = get_string('loginbackgroundimagesetting', 'theme_boost_unifr', null, true);
    $description = get_string('loginbackgroundimagesetting_desc', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/loginbackgroundimagetext';
    ...
    $name = 'theme_boost_unifr/loginform';
    $title = get_string('loginform', 'theme_boost_unifr', null, true);
    $description = get_string('loginform_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no'); // Overriding default values
        // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
        // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $name = 'theme_boost_unifr/fontdesignheading';
    $title = get_string('fontdesignheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Font files upload.
    $name = 'theme_boost_unifr/fontfiles';
    $title = get_string('fontfilessetting', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/blockdesignheading';
    $title = get_string('blockdesignheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Setting for displaying a standard Font Awesome icon in front of the block title.
    $name = 'theme_boost_unifr/blockicon';
    $title = get_string('blockiconsetting', 'theme_boost_unifr', null, true);
    $description = get_string('blockiconsetting_desc', 'theme_boost_unifr', null, true) .
        get_string('blockiconsetting_desc_code', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no'); // Overriding default values
        // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
        // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
        $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $name = 'theme_boost_unifr/blockcolumnwidthdashboard';
    $title = get_string('blockcolumnwidthdashboardsetting', 'theme_boost_unifr', null, true);
    $description = get_string('blockcolumnwidthdashboardsetting_desc', 'theme_boost_unifr', null, true).' '.
            get_string('blockcolumnwidthdefault', 'theme_boost_unifr', null, true);
    ...
    $name = 'theme_boost_unifr/blockcolumnwidth';
    $title = get_string('blockcolumnwidthsetting', 'theme_boost_unifr', null, true);
    $description = get_string('blockcolumnwidthsetting_desc', 'theme_boost_unifr', null, true).' '.
            get_string('blockcolumnwidthdefault', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configtext_with_maxlength($name, $title, $description, 360, PARAM_INT, null, 3);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    $name = 'theme_boost_unifr/navbardesignheading';
    $title = get_string('navbardesignheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    $name = 'theme_boost_unifr/darknavbar';
    $title = get_string('darknavbarsetting', 'theme_boost_unifr', null, true);
    $description = get_string('darknavbarsetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no' ); // Overriding default values
    // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
    // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    // Settings title to group navbar related settings together with a common heading. We don't want a description here.
    $name = 'theme_boost_unifr/helptextheading';
    $title = get_string('helptextheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    $name = 'theme_boost_unifr/helptextmodal';
    $title = get_string('helptextmodalsetting', 'theme_boost_unifr', null, true);
    $description = get_string('helptextmodalsetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no' ); // Overriding default values
    // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
    // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $name = 'theme_boost_unifr/breakpointheading';
    $title = get_string('breakpointheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    $name = 'theme_boost_unifr/breakpoint';
    $title = get_string('breakpointsetting', 'theme_boost_unifr', null, true);
    $description = get_string('breakpointsetting_desc', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_configcheckbox($name, $title, $description, 'no', 'yes', 'no' ); // Overriding default values
    // yes = 1 and no = 0 because of the use of empty() in theme_boost_unifr_get_pre_scss() (lib.php). Default 0 value would
    // not write the variable to scss that could cause the scss to crash if used in that file. See MDL-58376.
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    $name = 'theme_boost_unifr/additionalresourcesheading';
    $title = get_string('additionalresourcesheadingsetting', 'theme_boost_unifr', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Background image setting.
    $name = 'theme_boost_unifr/additionalresources';
    $title = get_string('additionalresourcessetting', 'theme_boost_unifr', null, true);
