...
namespace theme_boost_unifr\privacy;
...
class provider implements \core_privacy\local\metadata\provider,
    ...
    public static function get_metadata(collection $collection) : collection {
        $collection->add_user_preference('theme_boost_unifr_infobanner_dismissed',
    ...
    public static function export_user_preferences(int $userid) {
        $infobannerpref = get_user_preferences('theme_boost_unifr_infobanner_dismissed', null, $userid);
        if ($infobannerpref !== null) {
            ...
            writer::export_user_preference('theme_boost_unifr', 'theme_boost_unifr_infobanner_dismissed',
